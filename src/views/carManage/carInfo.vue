        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="状态">
              <el-select v-model="operateCarForm.carStatus" clearable placeholder="请选择" :disabled="operateDisable">
                <el-option
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="所属组织">
              <el-select v-model="operateCarForm.orgID" clearable placeholder="请选择" style="width: 100%" :disabled="operateDisable">
                <el-option
                  v-for="item in orgList"
                  :key="item.orgID"
                  :label="item.orgName"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="驾驶员">
              <el-select v-model="operateCarForm.driverID" clearable placeholder="请选择" :disabled="operateDisable"> 
                <el-option
  ...
  methods: {
    ...
    getDriverList() {
      axios
        ...
        .then(response => (this.driverList = response.data))
    },
    getCarTypeList() {
      axios
        .get('http://127.0.0.1:9090/car/type')
        .then(response => (this.carTypeList = response.data))
    },
    getCarStatusList() {
      axios
        .get('http://127.0.0.1:9090/car/status')
        .then(response => (this.carStatusList = response.data))
    },
    visibleAddDialog() {
