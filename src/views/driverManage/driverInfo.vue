    ...
    <div id="app-driverinfo">
        <el-row class="query-bar">
            ...
            <el-col :span="8" :offset="0">
                <el-button type="primary" @click="visibleAddDialog">新增驾驶员</el-button>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button type="text" @click="deleteDriver(scope.row)" size="small">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
        ...
        <el-dialog :title="operateDialogTitle" :visible.sync="operateDialogVisible" width="600px">
            <el-form :model="operateDriverForm" ref="operateDriverForm" label-width="100px">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="驾驶员姓名" required>
                            <el-input v-model="operateCarForm.driverName" :disabled="operateDisable"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="联系电话">
                            <el-input v-model="operateCarForm.phone" :disabled="operateDisable"></el-input>
                        </el-form-item>
                    </el-col>
<!--                    <el-col :span="12">-->
